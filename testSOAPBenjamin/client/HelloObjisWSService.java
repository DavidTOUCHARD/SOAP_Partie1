 ...
 * 
 */
@WebServiceClient(name = "HelloObjisWSService", targetNamespace = "http://service.DemoProviderSOAP.ensup.eu/", wsdlLocation = "http://192.168.43.47:8888/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOOBJISWSSERVICE_QNAME = new QName("http://service.DemoProviderSOAP.ensup.eu/", "HelloObjisWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.43.47:8888/hello?wsdl");
    ...
    public IHelloObjis getHelloObjisWSPort() {
        return super.getPort(new QName("http://service.DemoProviderSOAP.ensup.eu/", "HelloObjisWSPort"), IHelloObjis.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloObjisWSPort")
    public IHelloObjis getHelloObjisWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.DemoProviderSOAP.ensup.eu/", "HelloObjisWSPort"), IHelloObjis.class, features);
    }
